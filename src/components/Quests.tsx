...
export const Quests: FC<QuestsProps> = ({ onBack }) => {
    const quests: Quest[] = [
        {
            id: 'godot-mcp',
            name: "Godot MCP tooling",
            description: "A MCP server linking Godot workflows to developer environments",
            status: 'completed',
            reward: "⭐ 50 EXP & 10 Gold",
            url: "https://github.com/bauneAustin/godot_mcp"
        },
        {
            id: 'aseprite-mcp',
            ...
            url: "https://github.com/bauneAustin/aseprite_mcp"
        },
    ];
